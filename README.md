...
Breezy Desktop is a virtual workspace solution for Linux desktops that use the KDE Plasma 6 or GNOME desktop environments (versions 45 through 51). It supports launching multiple virtual monitors alongside multiple physical monitors.
...
Breezy Desktop has best compatibility with GNOME versions 45 through 51.
